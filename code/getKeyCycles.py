...
# ------- More Details --------
# 
# Here we find consecutive cycles, meaning there is no overlap, as we did in the C++ app.
#
# from findCycles.py comments:
#
...
from getCycles import getCycles, getConsecutiveCycles
...
getConsecutiveCycles(waveform, sample_rate, weakf0)
...
if args < 3 :
    ...
    print("cycle number i to write bcoeffs to file bcoeffs*.txt with *=i")
    print("so arguments on command will be:")
    print("<findCycles.py> <audiofilename.wav> <n> <seg_num> <i>")
    sys.exit(0)
...
f0 = arg_max
bcoeffs_to_export = [0, 5, 10, 30, 60, 90]
