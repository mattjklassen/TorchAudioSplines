...
from genWavTone import genWavTone, insertWavTone, insertWavTone2
...
# first need to parse mel5config.txt
...
start_time = 0.0
# subintervals which represent note durations
# times at which notes begin:
...
# and spline values.  Note i starts at time x[i] with pitch 2^y[i] and goes through time x[i+1]
...
# set total time for melody to duration_scalar:
...
#   print("key_knots: ", key_knots)
    ...
    # insertWavTone(waveform, start_time, f, time1, sample_rate, key_bcoeffs, note_keys[i], gains, interp_method)
