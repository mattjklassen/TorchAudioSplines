...
# starting with int(a) on the left, and ending with -int(-b) on the right.
...
def plotCycleSpline(waveform, a, b, n) :
...
b = 200.2
n = 30
plotCycleSpline(waveform, a, b, n)
